...
Namespace Vitens.DynamicBandwidthMonitor
  ...
  Public Class DBMTests
    ...
    Public Shared Sub RunUnitTests
      ...
      AssertAlmostEqual(Lerp(71.79, 81.12, 0.75), 78.7875)
      AssertAlmostEqual(Lerp(56.86, 108.88, 0.85), 101.077)
      AssertAlmostEqual(Lerp(20.97, 21.8, 0.42), 21.3186)
      AssertEqual(Lerp(37.58, 92.05, 0.86), 84.4242)
      AssertAlmostEqual(Lerp(15.75, 70.04, 0.94), 66.7826)
      AssertAlmostEqual(Lerp(30.32, 53.71, 0.48), 41.5472)
      AssertAlmostEqual(Lerp(46.9, 94.51, 0.96), 92.6056)
      AssertEqual(Lerp(29.98, 69.19, 0.28), 40.9588)
      AssertAlmostEqual(Lerp(75.31, 116.31, 0.55), 97.86)
      ...
      AssertEqual(IsOnInterval(New DateTime(2016, 1, 1, 0, 0, 0)), True)
      AssertEqual(IsOnInterval(New DateTime(2016, 1, 1, 0, 4, 59)), False)
      AssertEqual(IsOnInterval(New DateTime(2016, 1, 1, 0, 5, 0)), True)
      AssertEqual(IsOnInterval(New DateTime(2016, 1, 1, 0, 5, 1)), False)
      AssertEqual(IsOnInterval(New DateTime(2016, 1, 1, 0, 6, 0)), False)
      AssertEqual(IsOnInterval(New DateTime(2016, 1, 1, 0, 7, 0)), False)
      AssertEqual(IsOnInterval(New DateTime(2016, 1, 1, 0, 8, 0)), False)
      AssertEqual(IsOnInterval(New DateTime(2016, 1, 1, 0, 9, 0)), False)
      AssertEqual(IsOnInterval(New DateTime(2016, 1, 1, 0, 10, 0)), True)
      AssertEqual(IsOnInterval(New DateTime(2016, 1, 1, 0, 15, 0)), True)
      AssertEqual(IsOnInterval(New DateTime(2016, 1, 1, 0, 20, 0)), True)
      AssertEqual(IsOnInterval(New DateTime(2016, 1, 1, 0, 31, 0)), False)
      AssertEqual(IsOnInterval(New DateTime(2016, 1, 1, 0, 45, 0)), True)
      AssertEqual(IsOnInterval(New DateTime(2016, 1, 1, 0, 15, 1)), False)
      AssertEqual(IsOnInterval(New DateTime(2016, 1, 1, 0, 30, 2)), False)
      AssertEqual(IsOnInterval(New DateTime(2016, 1, 1, 0, 45, 3)), False)
      AssertEqual(IsOnInterval(New DateTime(2016, 1, 1, 0, 14, 56)), False)
      AssertEqual(IsOnInterval(New DateTime(2016, 1, 1, 0, 29, 57)), False)
      AssertEqual(IsOnInterval(New DateTime(2016, 1, 1, 0, 44, 58)), False)
      AssertEqual(IsOnInterval(New DateTime(2016, 1, 1, 0, 59, 59)), False)
      ...
      For i = 0 To 19
        With {
          ...
          AssertAlmostEqual(.Mean, {7.3681, 7.3681, 7.3681, 7.3681, 7.3681,
            7.3681, 7.3681, 7.3681, 7.3681, 7.3681, 38.1667, 48.3333, 30.75,
            36.0833, 34.4167, 34.5833, 42.6667, 45.6667, 50.1667, 34.8333}(i))
          AssertAlmostEqual(.NMBE, {398.0969, 416.0187, 437.7704, 390.9361,
            384.3642, 388.3877, 444.655, 370.1159, 374.9029, 394.8594, 69.5568,
            59.4655, 93.8347, 71.1755, 88.1816, 84.3422, 73.7324, 66.6387,
            56.8854, 82.2919}(i))
          AssertAlmostEqual(.RMSD, {2989.2386, 3126.3668, 3276.7114, 2961.0182,
            2887.2295, 2908.9569, 3312.9214, 2759.7653, 2794.3277, 2970.5922,
            2709.0779, 2913.7367, 2939.9523, 2599.8648, 3092.6607, 2985.8331,
            3180.1242, 3063.4419, 2887.1264, 2936.4299}(i))
          AssertAlmostEqual(.CVRMSD, {405.6976, 424.3086, 444.7133, 401.8676,
            391.853, 394.8019, 449.6277, 374.5537, 379.2444, 403.167, 70.9802,
            60.2842, 95.6082, 72.0517, 89.8594, 86.3373, 74.5342, 67.0827,
            57.5507, 84.2994}(i))
          AssertAlmostEqual(.Slope, {-32.0319, -62.6199, 24.2059, -29.2527,
            1.0292, 9.7103, 66.421, -86.4539, -13.0385, -77.2581, 9.4424,
            -0.1552, 10.7659, 4.8889, -4.6572, -0.4548, -6.6652, 2.2442, 8.6539,
            -12.0462}(i))
          AssertAlmostEqual(.OriginSlope, {332.9316, 343.4086, 375.1472,
            327.2963, 326.3803, 331.1186, 387.454, 300.8927, 316.2121, 323.2501,
            52.1812, 50.5792, 75.2409, 60.0661, 73.5505, 61.2832, 59.1633,
            53.9967, 46.4227, 66.0541}(i))
          AssertAlmostEqual(.Angle, {-88.2119, -89.0851, 87.6343, -88.0421,
            45.8243, 84.1202, 89.1375, -89.3373, -85.6142, -89.2584, 83.9546,
            -8.8239, 84.6933, 78.4399, -77.8813, -24.4582, -81.4673, 65.9827,
            83.4085, -85.2545}(i))
          AssertAlmostEqual(.OriginAngle, {89.8279, 89.8332, 89.8473, 89.8249,
            89.8245, 89.827, 89.8521, 89.8096, 89.8188, 89.8228, 88.9021,
            88.8674, 89.2385, 89.0462, 89.221, 89.0651, 89.0317, 88.939, 88.766,
            89.1327}(i))
          AssertAlmostEqual(.Intercept, {3176.6184, 3534.0464, 3054.5708,
            3103.3799, 2831.8355, 2797.5181, 2794.2506, 3371.4399, 2865.7758,
            3485.998, 2332.5305, 2930.0031, 2585.1154, 2427.9251, 3229.618,
            2967.1468, 3472.9635, 2986.3475, 2469.7771, 3320.9411}(i))
          AssertAlmostEqual(.StandardError, {620.5878, 637.2008, 626.7368,
            744.1709, 615.386, 571.2899, 489.0381, 353.499, 459.3232, 599.643,
            544.1683, 523.5492, 590.2042, 436.8994, 644.5969, 698.2517, 478.875,
            384.1275, 419.8051, 657.4656}(i))
          AssertAlmostEqual(.Correlation, {-0.1747, -0.32, 0.1316, -0.1339,
            0.0057, 0.0583, 0.423, -0.6434, -0.0971, -0.4049, 0.4296, -0.0069,
            0.3208, 0.2029, -0.1209, -0.0154, -0.3016, 0.1484, 0.5294,
            -0.3121}(i))
          AssertAlmostEqual(.ModifiedCorrelation, {0.8898, 0.8777, 0.9148,
            0.8831, 0.903, 0.9093, 0.9345, 0.8709, 0.9039, 0.8694, 0.8665,
            0.9024, 0.8892, 0.908, 0.887, 0.8274, 0.8714, 0.8915, 0.9047,
            0.8561}(i))
          AssertAlmostEqual(.Determination, {0.0305, 0.1024, 0.0173, 0.0179, 0,
            0.0034, 0.1789, 0.414, 0.0094, 0.1639, 0.1845, 0, 0.1029, 0.0412,
            0.0146, 0.0002, 0.091, 0.022, 0.2803, 0.0974}(i))
          AssertEqual(.HasInsufficientData, False)
          AssertEqual(.Calibrated, False)
          AssertAlmostEqual(.SystematicError, {398.0969, 416.0187, 437.7704,
            390.9361, 384.3642, 388.3877, 444.655, 370.1159, 374.9029, 394.8594,
            69.5568, 59.4655, 93.8347, 71.1755, 88.1816, 84.3422, 73.7324,
            66.6387, 56.8854, 82.2919}(i))
          AssertAlmostEqual(.RandomError, {7.6008, 8.2898, 6.9429, 10.9314,
            7.4888, 6.4142, 4.9726, 4.4378, 4.3416, 8.3076, 1.4234, 0.8187,
            1.7735, 0.8762, 1.6778, 1.9952, 0.8017, 0.444, 0.6653, 2.0076}(i))
          AssertAlmostEqual(.Fit, {0.0305, 0.1024, 0.0173, 0.0179, 0, 0.0034,
            0.1789, 0.414, 0.0094, 0.1639, 0.1845, 0, 0.1029, 0.0412, 0.0146,
    ...
    Public Shared Sub RunIntegrationTests
      ...
      correlationPoints.Add(
        New DBMCorrelationPoint(New DBMPointDriverTestModel(168), False))
      ...
      For i = -19 To 19
        ...
        With result
          ...
          AssertAlmostEqual(.ForecastItem.Measurement, {522.7266, 720.5181,
            ...
            1193.524}(Abs(i)))
          AssertAlmostEqual(.ForecastItem.Forecast, {490.0639, 707.8219,
            1236.9731, 1220.4079, 393.6295, 621.9114, 1034.7145, 979.9767,
            430.0617, 668.4824, 1015.6794, 1073.5876, 534.4971, 479.156,
            1033.2331, 1035.3121, 399.9333, 334.6536, 1083.0548,
            1177.4554}(Abs(i)))
          AssertAlmostEqual(.ForecastItem.Range(0.95), {44.4118, 62.4018,
            72.6515, 156.533, 51.1018, 93.1895, 107.043, 83.8996, 63.9006,
            84.8675, 47.561, 101.6462, 18.6739, 102.9021, 108.4401, 81.7059,
            59.0067, 52.5366, 108.392, 52.0587}(Abs(i)))
          AssertAlmostEqual(.ForecastItem.Range(BandwidthCI), {67.2174, 94.4453,
            109.9583, 236.9134, 77.3428, 141.0426, 162.01, 126.9824, 96.7139,
            128.4473, 71.9838, 153.8419, 28.2631, 155.7427, 164.1246, 123.6622,
            89.3069, 79.5143, 164.0517, 78.791}(Abs(i)))
          AssertAlmostEqual(.ForecastItem.LowerControlLimit, {422.8465,
            613.3766, 1127.0148, 983.4945, 316.2867, 480.8688, 872.7046,
            852.9943, 333.3478, 540.0351, 943.6956, 919.7457, 506.234, 323.4133,
            869.1085, 911.6499, 310.6264, 255.1393, 919.003, 1098.6644}(Abs(i)))
          AssertAlmostEqual(.ForecastItem.UpperControlLimit, {557.2813,
            802.2672, 1346.9314, 1457.3213, 470.9723, 762.954, 1196.7245,
            1106.9591, 526.7755, 796.9298, 1087.6632, 1227.4295, 562.7602,
            634.8988, 1197.3577, 1158.9742, 489.2402, 414.1679, 1247.1065,
            1256.2464}(Abs(i)))
        End With
      Next i
