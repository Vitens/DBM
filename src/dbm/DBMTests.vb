  ...
  Public Class DBMTests
      ...
      For i = 0 To 19
        With {
          ...
          AssertAlmostEqual(.CVRMSD, {551.4651, 590.8653, 580.8802, 553.5407,
            ...
            57.5507, 84.2994}(i))
          AssertAlmostEqual(.Slope, {-24.5033, -66.5492, 47.225, -51.884,
            20.2971, 0.0147, 39.0896, -56.228, -10.7968, -62.8401, 9.4424,
            -0.1552, 10.7659, 4.8889, -4.6572, -0.4548, -6.6652, 2.2442, 8.6539,
            -12.0462}(i))
          AssertAlmostEqual(.OriginSlope, {369.8394, 382.7038, 413.0494,
            358.8963, 361.5504, 361.1656, 414.7603, 343.7824, 348.8288,
            364.6555, 52.1812, 50.5792, 75.2409, 60.0661, 73.5505, 61.2832,
            59.1633, 53.9967, 46.4227, 66.0541}(i))
          AssertAlmostEqual(.Angle, {-87.663, -89.1391, 88.7869, -88.8958,
            87.1794, 0.8408, 88.5346, -88.9811, -84.7084, -89.0883, 83.9546,
            -8.8239, 84.6933, 78.4399, -77.8813, -24.4582, -81.4673, 65.9827,
            83.4085, -85.2545}(i))
          AssertAlmostEqual(.OriginAngle, {89.8451, 89.8503, 89.8613, 89.8404,
            89.8415, 89.8414, 89.8619, 89.8333, 89.8357, 89.8429, 88.9021,
            88.8674, 89.2385, 89.0462, 89.221, 89.0651, 89.0317, 88.939, 88.766,
            89.1327}(i))
          AssertAlmostEqual(.Intercept, {3125.2098, 3560.3804, 2899.1988,
            3255.4791, 2704.4707, 2862.1616, 2977.2318, 3170.1271, 2850.0726,
            3387.9501, 2332.5305, 2930.0031, 2585.1154, 2427.9251, 3229.618,
            2967.1468, 3472.9635, 2986.3475, 2469.7771, 3320.9411}(i))
          AssertAlmostEqual(.StandardError, {582.4235, 633.7178, 535.2634,
            721.1612, 619.9069, 506.964, 526.5818, 484.6209, 527.9287, 573.7909,
            544.1683, 523.5492, 590.2042, 436.8994, 644.5969, 698.2517, 478.875,
            384.1275, 419.8051, 657.4656}(i))
          AssertAlmostEqual(.Correlation, {-0.1531, -0.3657, 0.3039, -0.2591,
            0.1216, 0.0001, 0.2714, -0.4221, -0.0795, -0.3766, 0.4296, -0.0069,
            0.3208, 0.2029, -0.1209, -0.0154, -0.3016, 0.1484, 0.5294,
            -0.3121}(i))
          AssertAlmostEqual(.ModifiedCorrelation, {0.8373, 0.8137, 0.8788,
            0.8134, 0.8604, 0.8538, 0.8762, 0.8209, 0.8471, 0.8151, 0.8665,
          ...
          AssertAlmostEqual(.Fit, {0.0234, 0.1337, 0.0924, 0.0671, 0.0148, 0,
            0.0737, 0.1782, 0.0063, 0.1418, 0.1845, 0, 0.1029, 0.0412, 0.0146,
    ...
    Public Shared Function RunQualityTests As String
      ...
      Console.WriteLine("> " & String.Format(sQualityTests, SE.Length,
        Calibrated, Mean(SE), StDevP(SE), Mean(RE), StDevP(RE), Mean(F),
        StDevP(F)))
