...
Console.WriteLine(Round(.Mean, 4).ToString & " " & Round(.NMBE, 4).ToString & " " & Round(.CVRMSD, 4).ToString)
'         AssertAlmostEqual(.Mean, {2990.3333, 3194.5833, 3158, 2971.25,
...
'         AssertAlmostEqual(.NMBE, {-1.0889, -1.089, -1.089, -1.0889, -1.0888,
'           -1.0888, -1.089, -1.0888, -1.0888, -1.0889, -1.0754, -1.0729,
'           -1.0794, -1.0758, -1.0787, -1.0781, -1.0763, -1.0748, -1.0721,
'           -1.0778}(i))
...
'         AssertAlmostEqual(.CVRMSD, {1.0594, 1.0625, 1.0567, 1.0702, 1.0639,
'           1.056, 1.055, 1.0566, 1.058, 1.0606, 1.0507, 1.0413, 1.053, 1.0427,
'           1.0524, 1.0566, 1.0417, 1.0359, 1.0384, 1.0571}(i))
