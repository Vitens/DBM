    ...
    Public Shared Sub RunUnitTests
      ...
      For i = 0 To 19
        With {
          ...
          AssertAlmostEqual(.Mean, {7.7646, 7.7646, 7.7646, 7.7646, 7.7646,
            7.7646, 7.7646, 7.7646, 7.7646, 7.7646, 38.1667, 48.3333, 30.75,
            36.0833, 34.4167, 34.5833, 42.6667, 45.6667, 50.1667, 34.8333}(i))
          AssertAlmostEqual(.NMBE, {94.8158, 101.304, 100.1419, 94.2096, 89.233,
            90.7657, 101.2775, 90.6386, 88.4759, 96.4571, 69.5568, 59.4655,
            93.8347, 71.1755, 88.1816, 84.3422, 73.7324, 66.6387, 56.8854,
            82.2919}(i))
          AssertAlmostEqual(.RMSD, {1506.3325, 1613.9546, 1586.6802, 1512.0019,
            1423.7891, 1437.56, 1602.1518, 1436.2596, 1403.9695, 1534.0649,
            2709.0779, 2913.7367, 2939.9523, 2599.8648, 3092.6607, 2985.8331,
            3180.1242, 3063.4419, 2887.1264, 2936.4299}(i))
          AssertAlmostEqual(.CVRMSD, {193.9998, 207.8604, 204.3478, 194.73,
            183.3691, 185.1426, 206.3403, 184.9752, 180.8165, 197.5715, 70.9802,
            60.2842, 95.6082, 72.0517, 89.8594, 86.3373, 74.5342, 67.0827,
            57.5507, 84.2994}(i))
          AssertAlmostEqual(.Slope, {-36.5232, -61.0483, 13.3225, -19.6503,
            -2.5503, 12.4599, 76.2341, -95.6699, -15.3229, -85.1377, 9.4424,
            -0.1552, 10.7659, 4.8889, -4.6572, -0.4548, -6.6652, 2.2442, 8.6539,
            -12.0462}(i))
          AssertAlmostEqual(.OriginSlope, {323.7568, 334.1857, 365.3399,
            320.4311, 318.256, 324.0467, 381.4515, 290.4808, 308.2014, 312.7391,
            52.1812, 50.5792, 75.2409, 60.0661, 73.5505, 61.2832, 59.1633,
            53.9967, 46.4227, 66.0541}(i))
          AssertAlmostEqual(.Angle, {-88.4316, -89.0616, 85.7074, -87.0867,
            -68.5896, 85.4114, 89.2485, -89.4011, -86.2661, -89.3271, 83.9546,
            -8.8239, 84.6933, 78.4399, -77.8813, -24.4582, -81.4673, 65.9827,
            83.4085, -85.2545}(i))
          AssertAlmostEqual(.OriginAngle, {89.823, 89.8286, 89.8432, 89.8212,
            89.82, 89.8232, 89.8498, 89.8028, 89.8141, 89.8168, 88.9021,
            88.8674, 89.2385, 89.0462, 89.221, 89.0651, 89.0317, 88.939, 88.766,
            89.1327}(i))
          AssertAlmostEqual(.Intercept, {3210.6482, 3522.143, 3137.0161,
            3030.6475, 2858.8776, 2776.717, 2719.9556, 3441.1957, 2883.0982,
            3545.6939, 2332.5305, 2930.0031, 2585.1154, 2427.9251, 3229.618,
            2967.1468, 3472.9635, 2986.3475, 2469.7771, 3320.9411}(i))
          AssertAlmostEqual(.StandardError, {270.7009, 293.6464, 257.8674,
            340.9997, 291.8751, 236.3249, 256.9065, 241.2262, 244.566, 269.4376,
            544.1683, 523.5492, 590.2042, 436.8994, 644.5969, 698.2517, 478.875,
            384.1275, 419.8051, 657.4656}(i))
          AssertAlmostEqual(.Correlation, {-0.1885, -0.3003, 0.0674, -0.0857,
            -0.0137, 0.0697, 0.4663, -0.6944, -0.1109, -0.4204, 0.4296, -0.0069,
            0.3208, 0.2029, -0.1209, -0.0154, -0.3016, 0.1484, 0.5294,
            -0.3121}(i))
          AssertAlmostEqual(.ModifiedCorrelation, {0.9026, 0.8944, 0.9227,
            0.901, 0.9151, 0.9223, 0.9478, 0.8853, 0.9174, 0.8827, 0.8665,
            0.9024, 0.8892, 0.908, 0.887, 0.8274, 0.8714, 0.8915, 0.9047,
            0.8561}(i))
          AssertAlmostEqual(.Determination, {0.0355, 0.0902, 0.0045, 0.0073,
            0.0002, 0.0049, 0.2175, 0.4822, 0.0123, 0.1767, 0.1845, 0, 0.1029,
          ...
          AssertAlmostEqual(.SystematicError, {94.8158, 101.304, 100.1419,
            94.2096, 89.233, 90.7657, 101.2775, 90.6386, 88.4759, 96.4571,
            69.5568, 59.4655, 93.8347, 71.1755, 88.1816, 84.3422, 73.7324,
            66.6387, 56.8854, 82.2919}(i))
          AssertAlmostEqual(.RandomError, {99.184, 106.5564, 104.2059, 100.5204,
            94.1361, 94.377, 105.0628, 94.3365, 92.3406, 101.1144, 1.4234,
            0.8187, 1.7735, 0.8762, 1.6778, 1.9952, 0.8017, 0.444, 0.6653,
            2.0076}(i))
          AssertAlmostEqual(.Fit, {0.0355, 0.0902, 0.0045, 0.0073, 0.0002,
            0.0049, 0.2175, 0.4822, 0.0123, 0.1767, 0.1845, 0, 0.1029, 0.0412,
...
console.writeline(.HasSuppressedEvent.ToString)
'         AssertAlmostEqual(.Factor, {1.4019, 0, 0, 0, 0, 0, 0, 0, 1.0342, 0, 0,
'           0, -8.391, 1.8358, 0, 0, 2.0324, 0, 0, 0}(Abs(i)))
'         If {0, 8, 12, 13, 16}.Contains(Abs(i)) Then
'           AssertTrue(.HasEvent)
'         Else
'           AssertFalse(.HasEvent)
'         End If
'         If {7}.Contains(Abs(i)) Then
...
'         End If
          AssertAlmostEqual(.ForecastItem.Measurement, {522.7266, 720.5181,
            ...
            1193.524}(Abs(i)))
          AssertAlmostEqual(.ForecastItem.Forecast, {490.2579, 704.2131,
            1235.619, 1226.1638, 392.3224, 620.4858, 1031.3444, 978.682,
            430.4763, 669.015, 1016.1982, 1069.0855, 533.6251, 482.3837,
            1034.2672, 1035.908, 397.3444, 335.6148, 1083.1701,
            1176.528}(Abs(i)))
          AssertAlmostEqual(.ForecastItem.Range(0.95), {15.3029, 25.4331,
            27.2292, 66.3877, 25.2375, 33.54, 37.3493, 35.0415, 23.7876,
            31.6638, 19.9832, 54.2759, 8.5681, 37.6389, 44.0209, 39.1247,
            29.6583, 20.7521, 41.7579, 20.0848}(Abs(i)))
          AssertAlmostEqual(.ForecastItem.Range(BandwidthCI), {23.161, 38.4931,
            41.2115, 100.478, 38.1971, 50.7629, 56.5283, 53.0355, 36.0027,
            47.9232, 30.2446, 82.1467, 12.9678, 56.9666, 66.6258, 59.2155,
            44.8879, 31.4083, 63.2008, 30.3984}(Abs(i)))
          AssertAlmostEqual(.ForecastItem.LowerControlLimit, {467.097, 665.72,
            1194.4075, 1125.6857, 354.1253, 569.7229, 974.8161, 925.6465,
            394.4736, 621.0918, 985.9536, 986.9387, 520.6573, 425.4171,
            967.6414, 976.6925, 352.4565, 304.2065, 1019.9693,
            1146.1296}(Abs(i)))
          AssertAlmostEqual(.ForecastItem.UpperControlLimit, {513.4189,
            742.7062, 1276.8305, 1326.6418, 430.5195, 671.2487, 1087.8727,
            1031.7174, 466.4789, 716.9383, 1046.4429, 1151.2322, 546.5929,
            539.3502, 1100.893, 1095.1235, 442.2323, 367.0231, 1146.3709,
            1206.9264}(Abs(i)))
        End With
      Next i
