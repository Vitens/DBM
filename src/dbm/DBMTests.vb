    ...
    Public Shared Sub RunUnitTests
      ...
      For i = 0 To 19
        With {
          ...
          AssertAlmostEqual(.SystematicError, {375.9746, 391.5667, 416.3373,
            369.6653, 364.6431, 369.0719, 425.5359, 346.52, 354.9899, 370.5104,
            69.5568, 59.4655, 93.8347, 71.1755, 88.1816, 84.3422, 73.7324,
            66.6387, 56.8854, 82.2919}(i))
          AssertAlmostEqual(.RandomError, {7.3147, 7.7415, 6.8648, 10.3606,
            6.9414, 6.3373, 4.5876, 4.0631, 3.9539, 8.122, 1.4234, 0.8187,
