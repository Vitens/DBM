  ...
  Public Class DBMTests
    ...
    Public Shared Function UnitTestsPassed As Boolean
      ...
      UnitTestsPassed = UnitTestsPassed And _
        ...
        Round(ControlLimit({6,4,9,0}, 0.99), 4) = 19.0906 And _
        ...
        Round(ControlLimit({10,9,1,4}, 0.99), 4) = 22.9087 And _
        Round(ControlLimit({8,10,5,7}, 0.99), 4) = 11.4543 And _
        Round(ControlLimit({8,4,0,0}, 0.99), 4) = 15.2724
