...
Namespace Vitens.DynamicBandwidthMonitor
  ...
  Public Class DBMTests
    ...
    Public Shared Sub RunUnitTests
      ...
      AssertAlmostEqual(ExponentialWeights(6)(5), 0.3295)
      AssertAlmostEqual(ExponentialWeights(7)(6), 0.2885)
      AssertAlmostEqual(ExponentialWeights(8)(7), 0.2566)
      AssertAlmostEqual(ExponentialWeights(9)(8), 0.231)
      AssertAlmostEqual(ExponentialWeights(10)(9), 0.2101)
      AssertAlmostEqual(ExponentialWeights(11)(10), 0.1926)
      AssertAlmostEqual(ExponentialWeights(12)(11), 0.1778)
      AssertAlmostEqual(ExponentialWeights(13)(12), 0.1651)
      AssertAlmostEqual(ExponentialWeights(14)(13), 0.1541)
      AssertAlmostEqual(ExponentialWeights(15)(14), 0.1445)
      AssertAlmostEqual(ExponentialWeights(16)(15), 0.136)
      AssertAlmostEqual(ExponentialWeights(17)(16), 0.1285)
      AssertAlmostEqual(ExponentialWeights(18)(17), 0.1217)
      AssertAlmostEqual(ExponentialWeights(19)(18), 0.1156)
      AssertAlmostEqual(ExponentialWeights(20)(19), 0.1101)
      ...
      AssertAlmostEqual(ExponentialMovingAverage(
        {26.1368, 78.5212, NaN, 28.9665, NaN, NaN}), 41.9033)
