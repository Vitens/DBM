...
Namespace Vitens.DynamicBandwidthMonitor
  ...
  Public Class DBMTests
    ...
    Public Shared Sub RunUnitTests
      ...
      AssertEqual(EMATimeOffsetIntervals(2), 0)
      AssertEqual(EMATimeOffsetIntervals(3), 1)
      AssertEqual(EMATimeOffsetIntervals(4), 1)
      AssertEqual(EMATimeOffsetIntervals(5), 1)
      AssertEqual(EMATimeOffsetIntervals(6), 2)
      AssertEqual(EMATimeOffsetIntervals(7), 2)
      AssertEqual(EMATimeOffsetIntervals(8), 2)
      AssertEqual(EMATimeOffsetIntervals(9), 3)
      AssertEqual(EMATimeOffsetIntervals(10), 3)
      AssertEqual(EMATimeOffsetIntervals(11), 3)
      AssertEqual(EMATimeOffsetIntervals(12), 4)
      AssertEqual(EMATimeOffsetIntervals(13), 4)
      AssertEqual(EMATimeOffsetIntervals(14), 4)
      AssertEqual(EMATimeOffsetIntervals(15), 5)
      AssertEqual(EMATimeOffsetIntervals(16), 5)
      AssertEqual(EMATimeOffsetIntervals(17), 5)
      AssertEqual(EMATimeOffsetIntervals(18), 6)
      AssertEqual(EMATimeOffsetIntervals(19), 6)
      AssertEqual(EMATimeOffsetIntervals(EMAPreviousPeriods+1), 2)
