...
Namespace Vitens.DynamicBandwidthMonitor
  ...
  Public Class DBMMath
    ...
    Public Shared Function MedianAbsoluteDeviationScaleFactor(
      ...
      ' Precomputed results
      If n >= 1 Then Return {1, 1.22474487139159, 1.30737355162931,
        1.35007956889414, 1.37610857899973, 1.39361518673972, 1.4061893574828,
        1.41565536789524, 1.42303754709167, 1.42895507991759, 1.43380414275432,
        1.43784994510845, 1.44127668562794, 1.44421627361238, 1.44676564546013,
        1.44899762977097, 1.45096800028155, 1.45272019040865, 1.45428852628216,
        1.45570049423867, 1.45697836315859, 1.45814036605892, 1.45920157455578,
        1.46017455544875, 1.46106987022385, 1.46189645963019, 1.46266194303554,
        1.46337285380522, 1.46403482610491, 1.4826022185056}(Min(n, 30)-1)
    ...
    Public Shared Function ControlLimitRejectionCriterion(p As Double,
      ...
      ' Precomputed results
      If p = 0.9 And n >= 1 Then Return {6.31375151467503, 2.91998558035372,
      ...
      If p = 0.95 And n >= 1 Then Return {12.7062047361747, 4.30265272974947,
      ...
      If p = 0.98 And n >= 1 Then Return {31.8205159537738, 6.96455673428326,
      ...
      If p = 0.99 And n >= 1 Then Return {63.656741162872, 9.92484320091832,
