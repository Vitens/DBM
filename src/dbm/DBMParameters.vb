...
Namespace DBM
    ...
    Public Class DBMParameters
        ...
        Public Shared MaxDBMDataManagerCacheSize As Integer= MaxDBMPointCacheSize*(ComparePatterns+1) ' Maximum number of cached values per point; large enough for at least one day.
