...
Namespace DBM
    ...
    Public Class DBMParameters
        ...
        Public Shared MaxDBMPointCacheSize As Integer=      CInt((24*3600/CalculationInterval+EMAPreviousPeriods+CorrelationPreviousPeriods)) ' Maximum number of cached prediction results per point; large enough for at least one day.
        Public Shared MaxDBMDataManagerCacheSize As Integer=CInt(MaxDBMPointCacheSize*(ComparePatterns+1)) ' Maximum number of cached values per point; large enough for at least one day.
