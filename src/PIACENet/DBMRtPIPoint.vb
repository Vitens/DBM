                ...
                For Each SubstringA In SubstringsA
                    ...
                    Try
                        If Not DBMRtCalculator.PISDK.Servers(SubstringsB(0).Substring(If(SubstringsB(0).Substring(0,1).Equals("-"),1,0))).PIPoints(SubstringsB(1)).Name.Equals(String.Empty) Then
                            CorrelationPoints.Add(New DBM.DBMCorrelationPoint(New DBM.DBMPointDriver(DBMRtCalculator.PISDK.Servers(SubstringsB(0).Substring(If(SubstringsB(0).Substring(0,1).Equals("-"),1,0))).PIPoints(SubstringsB(1))),SubstringsB(0).Substring(0,1).Equals("-"))) ' Add to correlation points
                        End If
                    Catch
                    End Try
                Next
